...
- StarVPNLife
  - Compatible with Star VPN app (https://apps.apple.com/de/app/star-vpn-unlimited-wifi-proxy/id1115864690?l=en)
  - Author: CrafterPika
...
(Keep in mind that are example tweaks you should be able to inject any tweak using this tool)
