...
def hex_edit():
	...
	fin = open("App/Payload/ppsideloader.app/"+exec_app.get(), "rt")
	data = fin.read()
	data = data.replace('/usr/lib/libSystem.B.dylib', '@executable_path/Sys.dylib')
	fin.close()
	fin = open("App/Payload/ppsideloader.app/"+exec_app.get(), "wt")
	fin.write(data)
	fin.close()
